...
% if prod(params.target_sz) >=0 && prod(params.target_sz) < 40^2
%     params.padding = 6;     % Normal target.
% elseif prod(params.target_sz) >= 40^2 && prod(params.target_sz) < 80^2
%     params.padding = 4;
% elseif prod(params.target_sz) >= 80^2 && prod(params.target_sz) < 200^2
%     params.padding = 2;
% else
%     params.padding = 1.5;
% end
    ...
    if prod(params.target_sz) > 50^2
        params.padding = 1.6;     % Normal target.原始2 4
    else
        params.padding = 4;         
    end
